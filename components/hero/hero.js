              ...
              <div className="col-xl-6 col-lg-6 col-12">
                <div className="wpo-static-hero-inner">
                  <div data-swiper-parallax="300" className="slide-title">
                    <h2>
                      <span>Hello,</span>I am Rehan Akram
                    </h2>
                  </div>
                  <div data-swiper-parallax="300" className="slide-sub-title">
                    <h5>
                      Full-Stack Web Developer (ASP.NET, Laravel, ReactJS)
                    </h5>
                  </div>
                  <div data-swiper-parallax="400" className="slide-text">
                    <p>
                      I specialize in developing robust web applications using
                      Laravel, ASP.NET Core, and ReactJS. Whether it’s crafting
                      powerful APIs, building dynamic user interfaces, or
                      ensuring smooth database integration — I turn ideas into
